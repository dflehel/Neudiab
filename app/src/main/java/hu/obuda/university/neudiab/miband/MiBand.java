...
import hu.obuda.university.neudiab.miband.listeners.RealtimeStepsNotifyListener;
import hu.obuda.university.neudiab.miband.model.BatteryInfo;
import hu.obuda.university.neudiab.miband.model.LedColor;
import hu.obuda.university.neudiab.miband.model.Profile;
import hu.obuda.university.neudiab.miband.model.Protocol;
import hu.obuda.university.neudiab.miband.model.UserInfo;
import hu.obuda.university.neudiab.miband.model.VibrationMode;
    ...
    public void setHeartRateScanListener(final HeartRateNotifyListener listener) {
        this.io.setNotifyListener(Profile.UUID_SERVICE_HEARTRATE, Profile.UUID_NOTIFICATION_HEARTRATE, new NotifyListener() {
            ...
            public void onNotify(byte[] data) {
                Log.d(TAG, Arrays.toString(data));
                int i =data[1];
                DATA_CONTANIER.inserttohrlist(i);
